...
• 🏫 Gestão de Salas e Técnicos: Permite o registo e organização de salas, laboratórios e técnicos. Facilita a associação de equipamentos a salas e a atribuição de responsabilidades aos técnicos, melhorando a coordenação.

• 💻 Inventário Detalhado de Equipamentos: Mantém um registo completo de todos os ativos tecnológicos, incluindo especificações, localização e histórico de manutenção. Garante a precisão das informações para auditorias e planeamento.

• 🛠 Registo e Acompanhamento de Intervenções: Facilita a criação, atribuição e monitorização de pedidos de intervenção técnica. Permite que utilizadores reportem problemas e técnicos atualizem o estado das tarefas, assegurando uma resolução ágil.
